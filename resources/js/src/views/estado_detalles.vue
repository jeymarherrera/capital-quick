                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:;">Estado de Resultado</a></li>
                                                ...
                                                <div class="inv--head-section inv--detail-section">
                                                    <div class="row">
                                                        <div class="col-sm-6 col-12 me-auto">
                                                            <div class="d-flex" v-if="balances.data">
                                                                <img class="company-logo" src="@/assets/images/cork-logo.png" alt="company" />
                                                                <h3 class="in-heading align-self-center">{{ balances.data.titulo }}</h3>
                                                            </div>
                                                        </div>

                                                        <div class="col-sm-6 align-self-center mt-3" v-if="balances.data">
                                                            <p class="inv-street-addr">Estado de Situación Financiera</p>
                                                            <p class="inv-email-address">Al {{balances.data.fecha}}</p>
