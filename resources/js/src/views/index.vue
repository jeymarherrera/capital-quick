                    ...
                    <div class="widget-heading">
                        ...
                        <div class="dropdown btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="ddlRevenue">
                                <li><a href="javascript:;" class="dropdown-item">Semanal</a></li>
                                <li><a href="javascript:;" class="dropdown-item">Mensual</a></li>
                                <li><a href="javascript:;" class="dropdown-item">Anual</a></li>
                            </ul>
                        </div>
                    </div>

                    <div class="widget-content">
                        <div class="chart-title">Ganancia Total <span class="text-primary ms-1">$10,840</span></div>
                ...
                <div class="widget widget-dailysales">
                    <div class="widget-heading">
                        <div>
                            ...
                            <span class="sub-title">Ir a las columnas para más detalles.</span>
                        </div>
                    ...
                    <div class="widget-heading">
                        ...
                        <div class="dropdown btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="ddlSummary">
                                <li><a href="javascript:;" class="dropdown-item">Ver Reporte</a></li>
                                <li><a href="javascript:;" class="dropdown-item">Editar Reporte</a></li>
                                <li><a href="javascript:;" class="dropdown-item">Marcar como finalizado</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="widget-content">
                ...
                <div class="widget widget-total-order">
                    <div class="widget-heading">
                        ...
                        <div>
                            ...
                            <div class="w-numeric-title">Total de Productos en Inventario</div>
                        </div>
                    </div>
...
<script setup>
    ...
    const revenue_series = ref([
        { name: 'Ingresos', data: [16800, 16800, 15500, 17800, 15500, 17000, 19000, 16000, 15000, 17000, 14000, 17000] },
        { name: 'Gastos', data: [16500, 17500, 16200, 17300, 16000, 19500, 16000, 17000, 16000, 19000, 18000, 19000] },
    ]);
    ...
    const daily_sales_options = computed(() => {
        return {
            ...
            xaxis: { labels: { show: false }, categories: ['Dom', 'Lun', 'Mar', 'Mie', 'Jue', 'Vie', 'Sab'] },
            yaxis: { show: false },
            fill: { opacity: 1 },
    ...
    //Total Orders
    const total_orders_series = ref([{ name: 'Ventas', data: [28, 40, 36, 52, 38, 60, 38, 52, 36, 40] }]);
