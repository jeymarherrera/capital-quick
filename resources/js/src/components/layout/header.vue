      ...
      <header class="header navbar navbar-expand-sm">
        <ul class="navbar-item theme-brand flex-row text-center">
          ...
          <li class="nav-item theme-text">
            <router-link to="/" class="nav-link"> CapitalQuick </router-link>
          </li>
        </ul>
                ...
                <a href="javascript:;" class="dropdown-item">
                  <div class="media server-log">
                    ...
                    <div class="media-body">
                      <div class="data-info">
                        <h6 class="">Deuda a proveedor</h6>
                        <p class="">hace 45 min</p>
                      </div>
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
          ...
          <li class="menu single-menu">
            ...
            <ul class="collapse submenu list-unstyled">
              ...
              <li>
                <router-link to="/apps/scrumboard">Scrumboard</router-link>
              </li>
              ...
              <li class="sub-sub-submenu-list">
                ...
                <ul class="collapse list-unstyled sub-submenu">
                  <li>
                    <router-link to="/apps/invoice/list">List</router-link>
                  </li>
                  <li>
                  ...
                  <li>
                    <router-link to="/apps/invoice/edit">Edit</router-link>
                  </li>
                </ul>
              </li>
          ...
          <li class="menu single-menu">
            ...
            <ul class="collapse submenu list-unstyled">
              <li>
                <router-link to="/components/ventas"
                  >Registro Ventas</router-link
                >
              </li>
              <li>
                <router-link to="/components/Compras"
                  >Registro Compras</router-link
                >
              </li>
              <li>
                <router-link to="/components/CostoOpe"
                  >Costo Operacionales</router-link
                >
              </li>
              <li>
                <router-link to="/components/flujoD">Vista Flujo</router-link>
              </li>
            ...
            <ul class="collapse submenu list-unstyled">
              ...
              <li>
                <router-link to="/elements/buttons-group"
                  >Button Groups</router-link
                >
              </li>
              <li>
                <router-link to="/elements/color-library"
                  >Color Library</router-link
                >
              </li>
              <li>
                <router-link to="/elements/dropdown">Dropdown</router-link>
              </li>
              <li><router-link to="/elements/infobox">Infobox</router-link></li>
              <li>
                <router-link to="/elements/jumbotron">Jumbotron</router-link>
              </li>
              <li><router-link to="/elements/loader">Loader</router-link></li>
              <li>
                <router-link to="/elements/pagination">Pagination</router-link>
              </li>
              <li>
                <router-link to="/elements/popovers">Popovers</router-link>
              </li>
              <li>
                <router-link to="/elements/progress-bar"
                  >Progress Bar</router-link
                >
              </li>
              <li><router-link to="/elements/search">Search</router-link></li>
              <li>
                <router-link to="/elements/tooltips">Tooltips</router-link>
              </li>
              <li>
                <router-link to="/elements/treeview">Treeview</router-link>
              </li>
              <li>
                <router-link to="/elements/typography">Typography</router-link>
              </li>
            </ul>
          </li>
            ...
            <ul class="collapse submenu list-unstyled">
              ...
              <li class="sub-sub-submenu-list">
                ...
                <ul class="collapse list-unstyled sub-submenu">
                  <li><router-link to="/tables/basic">Basic</router-link></li>
                  <li>
                    <router-link to="/tables/striped"
                      >Striped Table</router-link
                    >
                  </li>
                  <li>
                    <router-link to="/tables/order-sorting"
                      >Order Sorting</router-link
                    >
                  </li>
                  <li>
                    <router-link to="/tables/multi-column"
                      >Multi Column</router-link
                    >
                  </li>
                  <li>
                    <router-link to="/tables/multiple-tables"
                      >Multiple Tables</router-link
                    >
                  </li>
                  <li>
                    <router-link to="/tables/alt-pagination"
                      >Alt. Pagination</router-link
                    >
                  </li>
                  <li><router-link to="/tables/custom">Custom</router-link></li>
                  <li>
                    <router-link to="/tables/range-search"
                      >Range Search</router-link
                    >
                  </li>
                  <li><router-link to="/tables/export">Export</router-link></li>
                  <li>
                    <router-link to="/tables/live-dom-ordering"
                      >Live DOM ordering</router-link
                    >
                  </li>
                  <li>
          ...
          <li class="menu single-menu">
            ...
            <ul class="collapse submenu list-unstyled">
              ...
              <li>
                <router-link to="/forms/input-group">Input Group</router-link>
              </li>
              ...
              <li>
                <router-link to="/forms/input-mask">Input Mask</router-link>
              </li>
              <li><router-link to="/forms/select2">Select2</router-link></li>
              <li>
                <router-link to="/forms/touchspin">TouchSpin</router-link>
              </li>
              <li>
                <router-link to="/forms/checkbox-radio"
                  >Checkbox &amp; Radio</router-link
                >
              </li>
              <li><router-link to="/forms/switches">Switches</router-link></li>
              <li><router-link to="/forms/wizards">Wizards</router-link></li>
              <li>
                <router-link to="/forms/file-upload">File Upload</router-link>
              </li>
              <li>
                <router-link to="/forms/quill-editor">Quill Editor</router-link>
              </li>
              <li>
                <router-link to="/forms/markdown-editor"
                  >Markdown Editor</router-link
                >
              </li>
              <li>
              ...
              <li>
                <router-link to="/forms/clipboard">Clipboard</router-link>
              </li>
            </ul>
          </li>
